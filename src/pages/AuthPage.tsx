...
import { Eye, EyeOff, Heart, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen flex" style={{ background: '#f0fdf8' }}>
      ...
      <div className="hidden md:flex flex-1 flex-col justify-between p-12"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-emerald-300 text-sm">Trusted by 10,000+ families across India</span>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            {!isLogin && (
              <div>
                ...
                <input type="text" className="input" placeholder="Appi Reddy"
          ...
          <p className="text-sm text-center text-gray-500 mt-4">
            ...
            <button onClick={() => { setIsLogin(l => !l); setEmail(''); setPassword(''); setName('') }}
