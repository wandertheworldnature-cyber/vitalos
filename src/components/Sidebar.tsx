...
import {
  ...
  Battery, Utensils, Moon, Cpu, Watch, FolderOpen, Shield, FlaskRound
} from 'lucide-react'
...
const TIPS = [
  ...
  'Walk 8,000 steps — reduces diabetes risk by 22%.',
  '15 min sunlight boosts Vitamin D.',
  'Sleep 7-9 hours for heart health.',
  'Deep breathing 5 min/day lowers cortisol.',
  'Walnuts daily improve HDL cholesterol.',
  'Avoid sugary drinks — raise HbA1c fastest.',
]
...
export default function Sidebar() {
  ...
  async function loadAlerts() {
    if (!user?.id) return
    const { count } = await supabase.from('ai_insights').select('id',{count:'exact',head:true})
